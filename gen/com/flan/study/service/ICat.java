 ...
 * Original file: F:\\Project\\Eclipse\\StudyDemo\\src\\com\\flan\\study\\service\\ICat.aidl
 */
package com.flan.study.service;
public interface ICat extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.flan.study.service.ICat
{
private static final java.lang.String DESCRIPTOR = "com.flan.study.service.ICat";
...
/**
 * Cast an IBinder object into an com.flan.study.service.ICat interface,
 * generating a proxy if needed.
 */
public static com.flan.study.service.ICat asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.flan.study.service.ICat))) {
return ((com.flan.study.service.ICat)iin);
}
return new com.flan.study.service.ICat.Stub.Proxy(obj);
}
...
private static class Proxy implements com.flan.study.service.ICat
{
